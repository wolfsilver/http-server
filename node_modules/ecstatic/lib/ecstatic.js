...
var ecstatic = module.exports = function (dir, options) {
  ...
  return function middleware (req, res, next) {
    ...
    if(serverHeader !== false) {
      // Set common headers.
      res.setHeader('server', 'ecstatic-888'+version);
    }
    ...
    function serve(stat) {
      ...
      var data = fs.readFileSync(file, charSet);
      var getMatch = data.match(/<!--#include virtual="([^"]*)"-->/);
      if (getMatch && getMatch.length > 1) {
        ...
        // console.log('*********   %o' , includeFile);
          var r = new stream.Readable();

          r.push(data.replace(/<!--#include virtual="([^"]*)"-->/, includeFile));
          r.push(null);
